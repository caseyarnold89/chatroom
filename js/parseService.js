...
app.service('parseService', function($http){
  ...
  //Because we're making a POST request, we need a way to tell parse the data we want to give it, 
    //in your $http call (along with url and method) have a data property which has a value that is equal to another object which a key of text 
    //and a value of the message being passed to parse. IE data: {text: yourMessage} 
